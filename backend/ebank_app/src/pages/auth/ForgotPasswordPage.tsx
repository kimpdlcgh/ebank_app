...
const ForgotPasswordPage: React.FC = () => {
  ...
  const resolveEmailFromIdentifier = async (identifier: string): Promise<string> => {
    ...
    if (querySnapshot.empty) {
      throw new Error('Username not found. Please verify your username.');
    }

    const userData = querySnapshot.docs[0].data() as { email?: string };
    if (!userData.email) {
      throw new Error('No email is linked to this username. Please contact support.');
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      const emailToReset = await resolveEmailFromIdentifier(loginIdentifier.trim());
      await resetPassword(emailToReset);
      setResolvedEmail(emailToReset);
      setIsEmailSent(true);
    } catch (err: any) {
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm text-green-800">
                    ...
                    <p className="mt-1">
                      We sent a password reset link to <strong>{resolvedEmail}</strong>
                    </p>
                    <p className="mt-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-xs text-blue-800">
                    ...
                    <ul className="mt-1 space-y-1 list-disc list-inside">
                      ...
                      <li>You can enter either username or email here</li>
