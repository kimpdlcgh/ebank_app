...
const adminNavigationItems: Array<{
  ...
  },
  {
    ...
    icon: UsersRound,
    path: '/admin/clients',
    description: 'Client 360: profile, accounts, holdings, notes',
  ...
  {
    id: 'brokerage-orders',
    label: 'Brokerage Orders',
    icon: ClipboardList,
    path: '/admin/brokerage-orders',
    description: 'Review and fill client trade orders',
    permission: 'canManageTransactions'
  },
  {
    id: 'instruments',
    ...
    description: 'Tradable securities and prices',
  ...
  },
  {
    ...
    description: 'Manage account/product types',
    permission: 'canManageSettings'
  },
  {
    id: 'analytics',
