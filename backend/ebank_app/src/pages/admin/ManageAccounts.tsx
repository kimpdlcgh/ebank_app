...
// Fallback account type options used while the admin-managed categories are loading
// or if the `account_categories` collection is empty.
...
const ManageAccounts: React.FC = () => {
  ...
  const accountTypeOptions = (!accountCategoriesLoading && enabledAccountCategories.length > 0)
    ? enabledAccountCategories.map((category: any) => ({ value: category.code, label: category.name }))
