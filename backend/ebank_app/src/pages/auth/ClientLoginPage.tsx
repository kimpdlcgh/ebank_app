...
const ClientLoginPage: React.FC = () => {
  ...
  const forgotPasswordLink = formData.username.trim()
    ? `/forgot-password?loginHint=${encodeURIComponent(formData.username.trim())}`
    : '/forgot-password';
            ...
            <div className="mt-4 text-center">
              <div className="space-y-2">
                <Link
                  ...
                  className="inline-block text-sm text-green-600 hover:text-green-800 font-medium transition-colors duration-200 underline hover:no-underline"
                >
                ...
                <div>
                  <button
                    ...
                    className="text-xs text-gray-600 hover:text-gray-800 font-medium cursor-pointer transition-colors duration-200 underline hover:no-underline focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 rounded-md px-2 py-1"
                  >
                    Submit manual reset request
                  </button>
                </div>
              </div>
            </div>
